...
INPUT_FILE_ORG = 'organizations.txt'
...
FINANCIAL_DATA = ['ES6621000418401234567891', '4916697015082', '5390700823285988', '4929432390175839', '5105 1051 0 5 10 5100      ']
FINANCIAL_DATA_OCR = ['ES6621000418401234567891', '4916697015082', '5390700823285988', '4929432390175839']

CUSTOM_WORDS = ["confidencial", "contraseña"]
ORGANIZATIONS = ["University of Chicago Press", "Apple Inc"]
...
class FaroEntrypointTest(unittest.TestCase):
    ...
    def test_document_id_detection(self):
        faro_document_ids_entity = list(self.FARO_ENTITY_TEST_1['id_document'].keys())
    ...
    def test_mobile_phone_detection(self):
        faro_mobile_phone_number_entity = list(self.FARO_ENTITY_TEST_1['mobile'].keys())
    ...
    def test_monetary_quantity_detection(self):
        faro_monetary_quantity_entity = list(self.FARO_ENTITY_TEST_1['money'].keys())
    ...
    def test_params_verbose(self):
        ...
        self.assertTrue(faro_verbose_entity['phone'] is not None)
    ...
    def test_params_split_lines(self):
        ...
        self.assertTrue(faro_split_lines_entity.get('mobile') is None)

    def test_ocr(self):
        faro_ocr = _faro_run(INPUT_PATH, INPUT_FILE_OCR)
        faro_ocr_financial_data = list(faro_ocr['financial_data'].keys())
        self.assertTrue(len(faro_ocr_financial_data) == len(FINANCIAL_DATA_OCR))
        diff_list = (set(faro_ocr_financial_data) ^ set(FINANCIAL_DATA_OCR))
        self.assertTrue(len(diff_list) == 0)
    ...
    def test_custom_words(self):
        faro_custom_score = _faro_run(INPUT_PATH, INPUT_FILE_TESTS_TXT, SCORE_EXT)['custom_word']
        faro_custom_entity = _get_file_data(os.path.join(INPUT_PATH, INPUT_FILE_TESTS_TXT + "." + ENTITY_EXT))
        faro_entities = list(faro_custom_entity['entities']['custom_word'])
